...
export function Computer(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      >
        <meshStandardMaterial toneMapped={false} emissive="#35c19f" emissiveIntensity={2}>
          <RenderTexture
            attach="map"
            anisotropy={16}
          >
...
function FloatingText() {
  ...
  useFrame((state) => {
    ...
    // Animate X a bit like the big example did
    textRef.current.position.x = Math.sin(offset.current + state.clock.elapsedTime / 2)
  })
