...
function OsmosisExplanationText() {
    return <Text
        ...
        scale={0.3}
        rotation={[-Math.PI / 2, 0, 0]}
        position={[8.3, 0.5, -0.4]}
    >
        {`Osmosis is the largest decentralized exchange in 
the Cosmos ecosystem, facilitating cross-chain liquidity via IBC
with over $100M in total value locked (TVL).`}
    </Text>
...
via Webpack/SWC integration, enhancing network speed and application efficiency.

-Core contributor to open-sourced Osmosis codebase: Spearheaded 
 cross-functional feature development, performed code reviews for 1000+ PRs.`}
