...
function AwakeTextMesh() {
    const { nodes, materials } = useGLTF('./portfolio/awake/awakeText.glb')
    return (
...
useGLTF.preload('./portfolio/awake/awakeText.glb')

function AwakeLogo() {
    const { nodes, materials } = useGLTF('./portfolio/awake/awakeLogo.glb')
    return (
...
useGLTF.preload('./portfolio/awake/awakeLogo.glb')
